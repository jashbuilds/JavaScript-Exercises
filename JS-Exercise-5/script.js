...
stdName && mathMarks && sciMarks && engMarks.addEventListener('keyup', () => {
...
// if(arr.includes(5)){
//     for(let i = 0; i<= arr.indexOf(5); i++){
//         console.log("Digits till 5:", arr[i]);
//     }
//     console.log("Index of Digit 5:", arr.indexOf(5));
// }
